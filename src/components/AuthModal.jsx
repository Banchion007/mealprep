    ...
    <div className="auth-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="auth-modal" role="dialog" aria-modal="true">
        ...
        <div className="auth-modal__brand">
          ...
          <span className="auth-modal__brand-name">Humble Chef</span>
        </div>
        ...
        <div className="auth-modal__heading">
          ...
          <p className="auth-modal__sub">
            {tab === 'signin'
              ...
              : 'Join us and start ordering chef-crafted meals.'}
          </p>
        </div>
        ...
        <div className="auth-modal__body">
          ...
          <button className="auth-btn-google" onClick={handleGoogleSignIn} disabled={loading}>
            <svg className="auth-btn-google__icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
